...
declare_test
run_traditional aplusb.local asserts/aplusb.in t.out /dev/null\
  -r SE -p builtin:free -t 1000 -m 128

declare_test # 5
run_traditional aplusb.local m.in t.out /dev/null std\
  -r SE -p builtin:free -t 1000 -m 128

declare_test

run_traditional aplusb.local asserts/aplusb.in m.out /dev/null std\
  -r SE -p builtin:free -t 1000 -m 128

declare_test
run_traditional aplusb.local asserts/aplusb.in t.out /dev/null s\
  -r SE -p builtin:free -t 1000 -m 128
...
declare_test
run_traditional aplusb.local asserts/aplusb.in t.out /dev/null std\
  -r SE -p builtin:free -t 1000 -m -128
...
run_traditional stress.local asserts/stress.in t.out /dev/null std \
...
run_traditional sleep_1_7.local asserts/aplusb.in t.out /dev/null std \
  -r TLE -p builtin:free --memory=30 --timeout=1500

declare_test "CPU time TLE"
run_traditional cpu_1_7.local asserts/aplusb.in t.out /dev/null std \
  -r TLE -p builtin:free --memory=30 --realtime=6000 --cputime=1500

declare_test "segment fault"
run_traditional sigsegv.local asserts/aplusb.in t.out /dev/null std \
  -r RE -p builtin:free -t 1000

declare_test
run_traditional sigusr1.local asserts/aplusb.in t.out /dev/null std \
