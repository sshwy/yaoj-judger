 ...
 * @brief Judger for OI's interactive problem.  It accepts 6 arguments: the
 * executable filename, ther interactor's filename, interactor's input filename
 * (which the interactor shall use file IO to read), interactor's output
 * filename (use file IO to write), interactor's error output filename, and
 * executable's error output filename. Note that stdin and stdout of interactor
 * and executable will be piped together in a two way communication.
 * @date 2022-02-05
 *
